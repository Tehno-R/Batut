...
import bonus1 from "../../assets/Cum.png";
import bonus2 from "../../assets/Cup.png";
import bonus3 from "../../assets/Smilek.png";
    ...
    return (
        <div>
            ...
            <div className="grass-block">
                <img src="images/grass_back.png" alt="Трава" />
            </div>
            <div className="bottom-block">
                <div className="bottom" onClick={() => window.scrollTo({top: 5900, behavior: 'smooth'})}>
                    <img src="images/Red.png" alt="Register" />
                </div>
            </div>
        </div>
    );
