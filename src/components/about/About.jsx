        ...
        <div className="event-banner">
            ...
            <div className="content">
                ...
                <div className="buttons">
                    <button className="signup-button-about" onClick={() => window.scrollTo({top: 5900, behavior: 'smooth'})}>
                        ЗАПИСАТЬСЯ
                    </button>
                </div>
                <div className="buttons">
                    <button className="details-button" onClick={() => window.scrollTo({top: 1200, behavior: 'smooth'})}>
