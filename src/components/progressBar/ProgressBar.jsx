...
const ProgressBar = ({max, label}) => {
    ...
    return (
        <div className="progress-bar-container">
            <div className="graaaaas">
                <p className="age-description">Выбери полосу для себя</p>
                ...
                <div className="footer-grass-block">
                    <img src="images/footer-grass_back.png" alt="footer-back" />
                </div>
            </div>
        </div>
    );
